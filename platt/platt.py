...
if __name__ == '__main__':
    ...
    y = np.array((train[:, 46] > train[:, 45]) + 0)
    ...
    print np.arraty(cross_validation.cross_val_score(all_model_list, newX, newY.reshape(newY.shape[0]), cv=5, scoring = scorer_auc)).mean()
