...
if __name__ == '__main__':
    ...
    # rcParams['axes.prop_cycle'] = [(0.843, 0.188, 0.122)]
    ...
    datasets = os.listdir("data/test/300/industry")# 列出目录下的所有文件和目录
    for dataset in datasets:
        if dataset.endswith(".csv"):
            name = os.path.splitext(dataset)[0]
            train = np.array(pd.read_table("data/test/300/industry/" + dataset, sep = ","))
